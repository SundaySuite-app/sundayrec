 ...
 * garantert innholdsløst: v0.16.0-beta.1, v0.16.0-beta.2 og v0.17.0 bærer alle den samme «SundayRec — recording for church services… See the assets below…».
 *
 ...
 *
 * `scripts/release-notes.test.mjs` er den samme vakten som test, og
...
export function checkAll() {
  ...
  // Versjonsparitet mellom package.json, Cargo.toml og tauri.conf.json er
  // allerede `npm run version-sync` sin jobb, i samme CI-jobb som denne. Den
  // gjentas ikke her.
