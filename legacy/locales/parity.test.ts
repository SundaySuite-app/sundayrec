...
export const PAUSED_KEYS = new Set([
  ...
  // A5: e-postreléet. Adressen bekreftes én gang (dobbel opt-in), og skjermen
  // har fire tilstander å si sant om — pluss kvitteringsbryteren, som bare
  // finnes på et bekreftet abonnement. Norsk + engelsk nå; de fem pausede
  // språkene tas i språkrunden sammen med resten av `app/`.
  'app.setup.notify.relayLabel',
  'app.setup.notify.relayNone',
  'app.setup.notify.relayNoneDesc',
  'app.setup.notify.relayConfirm',
  'app.setup.notify.relayPending',
  'app.setup.notify.relayPendingDesc',
  'app.setup.notify.relayResend',
  'app.setup.notify.relayResendWait',
  'app.setup.notify.relayConfirmed',
  'app.setup.notify.relayConfirmedDesc',
  'app.setup.notify.relayUnsubscribe',
  'app.setup.notify.relaySuppressed',
  'app.setup.notify.relaySuppressedDesc',
  'app.setup.notify.relayOtherAddress',
  'app.setup.notify.relayNoEndpoint',
  'app.setup.notify.relayQueued',
  'app.setup.notify.relaySubscribed',
  'app.setup.notify.relayResent',
  'app.setup.notify.relayUnsubscribed',
  'app.setup.notify.relayFailed',
  'app.setup.notify.receipt',
  'app.setup.notify.receiptDesc',
  ...
  'app.export.use',
  // V1/PR2: Diagnose-skjermen — verktøyet som mistet flaten sin i fase B, som
  // en rad på Avansert. 83 nøkler, og 40 av dem er ÉN ting: motorens 20 stabile
  // feilkoder (`SR-*` + `REC-LOSS`) oversatt på KODEN, med tittel og råd hver.
  // Det er prisen for at en engelsk frivillig får «No audio device found» og
  // ikke motorens hardkodede norske prosa. Faktalinja (`detail`) er fortsatt
  // motorens — den er satt sammen med `format!` av tall som ikke finnes andre
  // steder — og den gjelden er notert til språkrunden sammen med disse.
  'app.diagnose.title',
  'app.diagnose.desc',
  'app.diagnose.run',
  'app.diagnose.running',
  'app.diagnose.failed',
  'app.diagnose.probeSkipped',
  'app.diagnose.copy',
  'app.diagnose.copied',
  'app.diagnose.copyFailed',
  'app.diagnose.savedTo',
  'app.diagnose.devicesTitle',
  'app.diagnose.noDevices',
  'app.diagnose.ipcTitle',
  'app.diagnose.test',
  'app.diagnose.testRunning',
  'app.diagnose.testBlocked',
  'app.diagnose.testOk',
  'app.diagnose.testFail',
  'app.diagnose.r.devices',
  'app.diagnose.r.selected',
  'app.diagnose.r.mic',
  'app.diagnose.r.engine',
  'app.diagnose.r.probe',
  'app.diagnose.v.notFound',
  'app.diagnose.v.defaultDevice',
  'app.diagnose.v.ffmpegOk',
  'app.diagnose.v.ffmpegMissing',
  'app.diagnose.v.unknown',
  'app.diagnose.v.probeSkipped',
  'app.diagnose.v.probeOk',
  'app.diagnose.v.probeFail',
  'app.diagnose.v.auth.authorized',
  'app.diagnose.v.auth.denied',
  'app.diagnose.v.auth.restricted',
  'app.diagnose.v.auth.notDetermined',
  'app.diagnose.v.auth.unknown',
  'app.diagnose.testErr.deviceNotFound',
  'app.diagnose.testErr.permissionDenied',
  'app.diagnose.testErr.ffmpegError',
  'app.diagnose.testErr.noAudio',
  'app.diagnose.testSig.silent',
  'app.diagnose.testSig.low',
  'app.diagnose.testSig.normal',
  'app.diagnose.f.ffmpeg01.title',
  'app.diagnose.f.ffmpeg01.hint',
  'app.diagnose.f.audio01.title',
  'app.diagnose.f.audio01.hint',
  'app.diagnose.f.audio02.title',
  'app.diagnose.f.audio02.hint',
  'app.diagnose.f.audio10.title',
  'app.diagnose.f.audio10.hint',
  'app.diagnose.f.rate01.title',
  'app.diagnose.f.rate01.hint',
  'app.diagnose.f.video01.title',
  'app.diagnose.f.video01.hint',
  'app.diagnose.f.video02.title',
  'app.diagnose.f.video02.hint',
  'app.diagnose.f.disk01.title',
  'app.diagnose.f.disk01.hint',
  'app.diagnose.f.disk02.title',
  'app.diagnose.f.disk02.hint',
  'app.diagnose.f.perm01.title',
  'app.diagnose.f.perm01.hint',
  'app.diagnose.f.perm02.title',
  'app.diagnose.f.perm02.hint',
  'app.diagnose.f.engine01.title',
  'app.diagnose.f.engine01.hint',
  'app.diagnose.f.capture01.title',
  'app.diagnose.f.capture01.hint',
  'app.diagnose.f.capture02.title',
  'app.diagnose.f.capture02.hint',
  'app.diagnose.f.crash01.title',
  'app.diagnose.f.crash01.hint',
  'app.diagnose.f.task01.title',
  'app.diagnose.f.task01.hint',
  'app.diagnose.f.log01.title',
  'app.diagnose.f.log01.hint',
  'app.diagnose.f.log02.title',
  'app.diagnose.f.log02.hint',
  'app.diagnose.f.ok.title',
