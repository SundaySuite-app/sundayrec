  ...
  body.innerHTML = `
    ...
    <details class="ob-consent-details">
      ...
      <ul class="ob-consent-list">
        ...
        <li>${esc(t('onboarding.consentCatQuality', 'Kvalitetsdata — om et opptak ble komplett (tapsprosent, verdikt), og grove intervaller for korrigeringene dine i redigeringsverktøyet, f.eks. «30–60 sekunder tidligere». Aldri lydinnhold, tekst eller klokkeslett.'))}</li>
