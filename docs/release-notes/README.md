...
innholdsløse teksten: v0.16.0-beta.1, v0.16.0-beta.2 og v0.17.0 bærer alle den samme «SundayRec — recording for church services… See the assets below…».
...
Vakten er `scripts/release-notes.test.mjs`, og den kjører på hver PR. Den stopper
